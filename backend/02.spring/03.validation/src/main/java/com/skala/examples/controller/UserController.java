...
import com.skala.examples.validator.MyValidator;
...
public class UserController {
    ...
    public UserController(MyValidator myValidator) {
    ...
    @PostMapping("/{id}")
    public ResponseEntity<User> customValidTest(
        @PathVariable int id, 
        ...
        BindingResult bindingResult) 
    {
        ...
        if (bindingResult.hasErrors()) {
            throw new RuntimeException(String.format("error=%s", bindingResult.getAllErrors()));
        }
